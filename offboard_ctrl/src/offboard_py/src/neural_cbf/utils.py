...
def load_phi_and_params(exp_name, checkpoint_number, device):
    ...
    ##### Load the parameters #####
    ###############################
    fnm = "/home/kai/nCBF-drone/danaus_ros_ws/offboard_ctrl/src/trained_ncbf/log/%s/args.txt" % exp_name
    ...
    param_dict = pickle.load(open("/home/kai/nCBF-drone/danaus_ros_ws/offboard_ctrl/src/trained_ncbf/log/%s/param_dict.pkl" % exp_name, "rb"))
    ...
    print("=====================================================")
    phi_load_fpth = "/home/kai/nCBF-drone/danaus_ros_ws/offboard_ctrl/src/trained_ncbf/checkpoint/%s/checkpoint_%i.pth" % (exp_name, checkpoint_number)
